...
import { adminchangepassword } from '../util/api';
import {
    Form,
    redirect,
    useActionData,
                ...
                <div className={styles.content}>
                    <div className={styles.login}>
                        ...
                        <Form className={styles.loginform} method='post'>
                            ...
                            <Link to='/admin/login' className={styles.linkStyle}>LogIn Instead</Link>
...
export async function action({ request }) {
    ...
    const loginError = await adminchangepassword(data);
    if (loginError) {
        return loginError;
    }
